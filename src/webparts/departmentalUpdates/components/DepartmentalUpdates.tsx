...
export default class DepartmentalUpdates extends React.Component<IDepartmentalUpdatesProps, {}> {
  public render(): React.ReactElement<IDepartmentalUpdatesProps> {
    ...
    return (
      <section className={`${styles.departmentalUpdates} ${hasTeamsContext ? styles.teams : ''}`}>
