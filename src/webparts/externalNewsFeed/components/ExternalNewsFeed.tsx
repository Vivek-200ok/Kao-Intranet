...
export default class ExternalNewsFeed extends React.Component<IExternalNewsFeedProps, {}> {
  public render(): React.ReactElement<IExternalNewsFeedProps> {
    ...
    return (
      <section className={`${styles.externalNewsFeed} ${hasTeamsContext ? styles.teams : ''}`}>
