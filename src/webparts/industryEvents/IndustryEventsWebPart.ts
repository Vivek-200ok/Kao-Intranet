...
export default class IndustryEventsWebPart extends BaseClientSideWebPart<IIndustryEventsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IIndustryEventsProps> = React.createElement(
      IndustryEvents,
      {
