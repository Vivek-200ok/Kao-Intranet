...
export default class YourAssistanceProgramme extends React.Component<IYourAssistanceProgrammeProps, {}> {
  public render(): React.ReactElement<IYourAssistanceProgrammeProps> {
    ...
    return (
      <section className={`${styles.yourAssistanceProgramme} ${hasTeamsContext ? styles.teams : ''}`}>
