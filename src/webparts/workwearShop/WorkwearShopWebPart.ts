...
export default class WorkwearShopWebPart extends BaseClientSideWebPart<IWorkwearShopWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IWorkwearShopProps> = React.createElement(
      WorkwearShop,
      {
